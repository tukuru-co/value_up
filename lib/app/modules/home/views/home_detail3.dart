...
class HomeDetail3 extends GetView<HomeController> {
  ...
  Widget customItemTabView1() {
    return Container(
      ...
      child: Text(
          controller.detailProduct??"No Information",
  ...
  Widget customItemTabView2() {
    return Container(
      padding: EdgeInsets.only(left: 13, right: 13, bottom: 20, top: 10),
      child: Center(
        child: Text(controller.term?? "No Information",  style: TextStyle(color: Colors.grey, fontSize: 12)),
      ),
    );
  }
}
